import json, os, re, requests; from utils import display_source; from d_noise_cleanup import is_usable_clause_text; from u_constants import (DEFAULT_OLLAMA_CONNECT_TIMEOUT, DEFAULT_OLLAMA_READ_TIMEOUT, OLLAMA_GENERATE_URL, SYNTHESIS_ARGUMENT_LIMIT, SYNTHESIS_MAX_CHAIN_CLAUSES, SYNTHESIS_MODEL, SYNTHESIS_TARGET_MATCH_THRESHOLD,)
from d_target_text import target_tokens; SPECIFIC_CITATION_RE = re.compile(r"(\d|%|\b[A-Z]{2,}\b)"); CONCRETE_DETAIL_RE = re.compile(
