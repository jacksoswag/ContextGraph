import hashlib, json, re, sqlite3, threading, time; from urllib.parse import urlparse; from u_constants import EXTRACTION_CACHE_PATH, EXTRACTION_CLAUSE_LIMIT, EXTRACTION_SENTENCE_LIMIT
from d_noise_cleanup import (MAX_AGENT_TOKENS, clean_agent_name, clean_clause_text, clean_source_text, clean_text, has_contraction_pronoun, is_usable_clause_text, is_usable_agent_text, is_usable_relation_text); from d_word_info_map import get_literal_index, literal_from_index, precache_text_vectors, text_similarity
from u_language_constants import (AMOUNT_UNIT_PATTERNS, CLAUSE_SPLIT_COORDINATORS, CORE_QUANTIFIER_TOKENS, DATE_MONTH_PATTERNS, LINKING_RELATION_PHRASES, LINKING_NEGATION_RELATIONS, MODIFIER_CUE_PHRASES, NEGATION_CUES, NEGATIVE_RELATION_FORMS, NON_NEGATING_PHRASES, PARTICIPIAL_MODIFIER_CUES, PERCENT_QUANTIFIER_QUALIFIERS, PERCENT_TOKENS, QUANTIFIER_EXCLUSION_PHRASES, QUANTIFIER_RULES, RELATION_STOPWORDS, SCOPE_BREAK_WORDS, SEMANTIC_NEGATION_EXACT_TERMS, SEMANTIC_NEGATION_PREFIXES, SEMANTIC_NEGATION_PROTOTYPES, SEMANTIC_NEGATION_SUFFIXES, STOPWORD_TOKENS, SUBJECT_PREFIX_PHRASES, TRAILING_NOISE_PHRASES, TRAILING_MODAL_TOKENS, YEAR_PREFIX_PATTERN)
from d_linguistic_roles import (dependency_relation, embedded_statement_text, looks_like_relation_word, parsed_tense, preparse_texts); from o_connection import ConnectionEndpoint
